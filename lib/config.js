...
exports.lookup_auth_member_following = (mb_id) => { //aggregateQuery.push dagi (follow_idni mb_id qilib pass qilayopman.)
  return {
      $lookup: {
        from: 'follows', //follows collectiondan lookup qilayopmiz.
        let: {
            lc_follow_id: '$subscriber_id', //lc bu local .bular variablelar.
